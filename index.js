...
//length: 11  
const questions = ['What is the title of the project?', 'Describe your application:', 'List prerequisites necessary, each separated by a pipe:',
     'List installation steps, separated by a pipe:', 'List steps to start the application, separated by a pipe:', 'Explain how to operate the main functionality of the application:', 
     'Which license would you like to use?', 'How can a user contribute to the project? List steps separated by a pipe.', 'How can a user run tests on the project?', 'What is your github username?', 
